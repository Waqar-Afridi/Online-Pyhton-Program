class phone:  # Base class or parent class  """ plar
...
class smartphone(phone): #drived class or child class  """bachy
    ...
    def full_name(self):
        return  f" Brand Name is  :{self.Brand_name}: and Model name :{self.Model_name}: and price is {self.price}"

class flagshipphone(smartphone):  # multi level inheritance   """ almasay
    def __init__(self, Brand_name, Model_name, price, ram, rear_camera,front_camera):
        super().__init__(Brand_name, Model_name, price, ram, rear_camera)
        self.front_camera=front_camera

    def full_name(self):
        return f" Brand Name is  :{self.Brand_name}: and Model name :{self.Model_name}: and price is {self.price} and front camera is{self.front_camera}"
